  ...
  return (
    <footer className={`grid grid-cols-1 gap-5 py-6 w-full darkBg mt-[-2px] lg:mt-0`}>
      <div className={`flex justify-center`}>
        <h1 className={`scroll-m-20 text-2xl lg:text-6xl font-extrabold tracking-tight ${useTitleTheme()}`}>
          {t('footer.header')}
        </h1>
      </div>
      <div className={`flex justify-center`}>
        <h3 className={`scroll-m-20 text-md lg:text-2xl tracking-tight lg:text-md text-white`}>
          {t('footer.subtitle')}
        </h3>
      </div>
      ...
      <div className={`grid grid-cols-3 mt-10 mx-16 lg:mx-auto gap-12 lg:gap-24`}>
        <div className={`flex flex-col`}>
          ...
          <Button
            onClick={() => navigate('/movesong-frontend/')}
            variant={`link`}
            className={`mt-3 text-white p-0 inline-flex justify-start w-0`}
          >
            {t('footer.homeText')}
          </Button>
          {user ? (
            <Button
              onClick={() => navigate('/movesong-frontend/transform')}
              variant={`link`}
              className={`mt-3 text-white p-0 inline-flex justify-start w-0`}
            >
              {t('footer.transformText')}
            </Button>
          ) : (
            <Button
              onClick={() => navigate('/movesong-frontend/register')}
              variant={`link`}
              className={`mt-3 text-white p-0 inline-flex justify-start w-0`}
            >
              {t('footer.registrationText')}
            </Button>
          )}
          <Button
            onClick={() => navigate('/movesong-frontend/profile')}
            variant={`link`}
            className={`mt-3 text-white p-0 inline-flex justify-start w-0`}
          >
            {t('footer.settingsText')}
          </Button>
          <Button
            onClick={() => navigate('/movesong-frontend/premium')}
            variant={`link`}
            className={`mt-3 text-white p-0 inline-flex justify-start w-0`}
          >
            {t('footer.packagesText')}
          </Button>
        </div>
        <div className={`flex flex-col`}>
          <p className={`font-bold text-white`}>{t('footer.helpText')}</p>
          <Button
            onClick={() => navigate('/movesong-frontend/contact')}
            variant={`link`}
            className={`mt-3 text-white p-0 inline-flex justify-start w-0`}
          >
          ...
          <Button
            onClick={() => navigate('/movesong-frontend/faq')}
            variant={`link`}
            className={`mt-3 text-white p-0 inline-flex justify-start w-0`}
          >
            {t('footer.faqText')}
        ...
        <div className={`flex flex-col text-left`}>
          ...
          <Button
            onClick={() => navigate('/movesong-frontend/terms-of-service')}
            variant={`link`}
            className={`mt-3 text-white p-0 inline-flex justify-start w-0 text-wrap md:text-nowrap lg:text-nowrap`}
          >
            {t('footer.termsOfUseText')}
          </Button>
          <Button
            onClick={() => navigate('/movesong-frontend/privacy-policy')}
            variant={`link`}
            className={`mt-3 text-white p-0  inline-flex justify-start w-0 text-wrap md:text-nowrap lg:text-nowrap`}
          >
