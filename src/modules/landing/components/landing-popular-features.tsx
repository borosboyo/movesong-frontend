  ...
  return (
    <div ref={domRef} className={`flex flex-col gap-10 ${isVisible ? 'fadeIn' : 'fadeOut'} py-20`}>
      <div className={`flex flex-col items-center gap-7`}>
        <h1 className={`scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-6xl ${useReverseTitleTheme()}`}>{t('landing.landingPopularFeatures.header')}</h1>
        <div className={`flex flex-col lg:flex-row gap-6 text-center`}>
          <FeatureCard title={`landing.landingPopularFeatures.transferHeader`} description={`landing.landingPopularFeatures.transferSubtitle`} icon={<MagicIcon size={100}/>} />
          <FeatureCard title={`landing.landingPopularFeatures.syncHeader`} description={`landing.landingPopularFeatures.syncSubtitle`} icon={<UpdateIcon size={100}/>} />
          <FeatureCard title={`landing.landingPopularFeatures.shareHeader`} description={`landing.landingPopularFeatures.shareSubtitle`} icon={<ShareIcon size={100}/>}/>
        </div>
      </div>
    </div>
  );
    ...
    <Card className={`max-w-md lg:pb-16 px-5 hoverGrow`}>
      <CardContent className={`aspect-square justify-center p-6`}>
        <div className={`flex flex-col items-center max-w-64`}>
          ...
          <span className={`w scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-3xl mt-4 lg:mt-16`}>{t(props.title)}</span>
