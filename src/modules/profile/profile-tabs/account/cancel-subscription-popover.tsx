...
export function CancelSubscriptionPopover({ subscription, setSubscription }: { subscription: FindSubscriptionResp | null, setSubscription: (_subscription: FindSubscriptionResp | null) => void }) {
  ...
  return <Popover>
    <PopoverTrigger asChild>
      <Button className={`text-red-500 w-full md:w-40 lg:w-40`} variant={`ghost`}>{t('profile.accountTab.cancelSubscriptionButtonText')}</Button>
    </PopoverTrigger>
    <PopoverContent>
