...
export function PremiumHeader({ subscription, setSubscription }: { subscription: FindSubscriptionResp | null, setSubscription: (_subscription: FindSubscriptionResp | null) => void }) {
  ...
  return (
    <>
      ...
      <div className={`grid w-full grid-cols-4`} style={{ gridTemplateColumns: '1.25fr 1.75fr 1fr 2fr' }}>
        <span className={`w scroll-m-20 text-s col-span-2 md:col-span-1 lg:col-span-1 font-light tracking-tight lg:text-s`}>
          {t('profile.accountTab.premiumBundle')}
        </span>
        <span className={`w scroll-m-20 text-s col-span-2 md:col-span-1 lg:col-span-1 font-bold tracking-tight lg:text-s`}>
