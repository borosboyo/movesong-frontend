  ...
  return (
    <PanelContainer>
      <div className={`flex flex-col items-center gap-8`}>
        <h1 className={`text-9xl font-extrabold tracking-tight lg:text-9xl`}>{t('errorPage.header')}</h1>
        <p className={`text-2xl font-light tracking-tight lg:text-2xl`}>{t('errorPage.text')}</p>
